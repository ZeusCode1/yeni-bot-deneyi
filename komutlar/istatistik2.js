...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("YELLOW")
    .addField("» **Botun Sahibi**", "<@777521730570682388>")
    ...
    .addField("**__Bot Sahibi__**", `Del + Orhan#7623`, true)
    .addField("**__Geliştirici__**", ` Del + Orhan#7623`, true)
    .addField("**__İşletim Sistemi__**", ` \`Windows 11 | 64 Bit\` `, true)
    .addField("**__CPU__**",` \`\`\`Intel(R) Core(TM) i5-4590 CPU @ 3.30GHz\`\`\` `)
