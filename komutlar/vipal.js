...
exports.run = async(client, message, args) => {
   if(!message.member.roles.cache.has('777521730570682388')) return message.channel.send('Bu komutu kullanabilmek için gerekli yetkiye sahip değilsin : `rôl adı`')
  ...
  client.channels.cache.get('954355347022286878').send(embed)///LOG KANAL İD YAZMALISIN
}
